...
<a href="#" class="list-group-item">getch()and getche()</a>
      ...
      <div class="col-sm-7 text-left" style="background-color: #fff; height: 100%"> 
        <div class=" row container-fluid text-center">
            <h3>Contact Us.</h3>
            <p align="left"><b>LearnDifferences</b><br> Room No.1 First Floor<br>Behind Tehshil, Anil Shivhare Bulding<br> Bihari Colony<br>
            Anuppur M.P. 484224</p>
            <p align="left"><b>Email:</b>ld@learndifferences.org</p>
