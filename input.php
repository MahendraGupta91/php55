...
function validateForm() {
    ...
    var ImageName1,ImageName2, TextName1,T-extName2,Imageextension1,ImageExtension2;
  ...
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      <div class="col-sm-8 text-left" ng-app="">
          ...
          <form onsubmit="return validateForm()" method="post" name="myForm" action="Mediator_article.php" enctype="multipart/form-data">
        ...
        <div class="container-fluid ">  
            <div class="col-sm-6 text-center"><input type="submit" onclick="switch(1)" value="Save and Publish"></div>
            <div class="col-sm-6 text-center"><input type="submit" onclick="switch(1)" value="Add New Point" name="publish"></div>
        </div>
