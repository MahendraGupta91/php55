...
<a href="#" class="list-group-item">getch()and getche()</a>
      ...
      <div class=" row container-fluid text-center">
            <h2>Welcome to LearnDifferences.</h2>
            
          
        </div>
           <hr >
      <div class="row container-fluid text-center">
               <img src="Profile_images/Virander_gupta.png" style="width: 200px; border-radius: 50%">
              <h3>Mr. Virander Gupta</h3>
              <p  align="justify">He is an entrepreneur and founder of LearnDifferences.
                  He is highly intrested in implementing new ideas.</p>
              
          </div>
           <hr >
     <div class="row container-fluid text-center">
              <img src="Profile_images/Sudhanshu_srivastava.png" style="width: 200px; border-radius: 50%">
              <h3>Mr. Sudhanshu Srivastava</h3>
              <p  align="justify">A Software Developer who always try to learn new technologies. He is a poet and social worker and also a grate motivator who is always intrested to talk on science, creativity and new ideas.</p>
              
          </div>
            <hr>
         <div class="row container-fluid text-center">
              <img src="Profile_images/Mahendra_Gupta.jpg" style="width: 200px; border-radius: 50%">
              <h3>Mr. Mahendra Gupta</h3>
              <p  align="justify" style="font: x-large">He is an JNU New Delhi alumni and advisor to LearnDifferences. He is working as lecturer in Computer Science. His is also working in the field of Data Mining and Machine Learning. He is highly intrested in solving problem using programming.   </p>
