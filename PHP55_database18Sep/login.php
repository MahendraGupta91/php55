    ...
    require_once './db_connection_maker.php';
     $GetMailId="SELECT EmailId FROM authortable WHERE EmailId= '$EmailID' AND password='$userPSD' ";
        ...
        if ($result->num_rows >0) 
        {
            ...
            $_SESSION["lgnStatus"]="YSS";
            
            $_SESSION["UserEmail"]=$row["EmailId"];
            $_SESSION["UserName"]=$row["AuthorName"];
                ...
                <div class="col-sm-6">
                    ...
                    <form action="login.php" method="POST" name="loginForm">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="userEmail" aria-describedby="emailHelp" placeholder="Enter email" required="">
                        </div>
                        <div class="form-group">
                        ...
                        if($matchFlag===1)
                        {
                            ...
                            echo '<div class="form-group">';
                                echo '<label type="text"><font color="orange">User ID or password is not matching!</font></label>';
                            echo '</div>';       
                        }
                        ?>
                        <div class="form-group">
