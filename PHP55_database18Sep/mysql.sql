...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 17, 2019 at 09:15 PM
...
--
-- Table structure for table `a123_b123_1805`
--

CREATE TABLE `a123_b123_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
  `imgname2` varchar(30) DEFAULT NULL,
  `imgtype1` varchar(5) DEFAULT NULL,
  `imgtype2` varchar(5) DEFAULT NULL,
  `referencename` text,
  `referenceurl` text
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `a123_b123_1805`
--

INSERT INTO `a123_b123_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'tytry', 'rwtywrety', '', '', '', '', '', ''),
(2, 'rtyerytert', 'ryurtyuryu', '', '', '', '', '', ''),
(3, 'rytujrytudfgh', 'kt6uiryhn', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `aasdasd_asdasd_1805`
--

CREATE TABLE `aasdasd_asdasd_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `aasdasd_asdasd_1805`
--

INSERT INTO `aasdasd_asdasd_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'asdEDFDF', 'SDFAEFR', '', '', '', '', '', ''),
(2, 'QEWRTQEWRT', 'QERTQERTQERT', '', '', '', '', 'QERTQERT', 'QERTTQERTQ'),
(3, 'QERTQERT', 'RRAFDVADF', '', '', '', '', 'AdsfERF', 'QEWRFQWERQ');

-- --------------------------------------------------------

--
-- Table structure for table `addadadad_adadada_1805`
--

CREATE TABLE `addadadad_adadada_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `addadadad_adadada_1805`
--

INSERT INTO `addadadad_adadada_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'rgsrt', 'etryety', '', '', '', '', '', ''),
(2, 'tryty', 'eyteryt', '', '', '', '', '', ''),
(3, 'eyteryt', 'ytuturyjn etyeryt', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `analolg_digital_1805`
--

CREATE TABLE `analolg_digital_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `analolg_digital_1805`
--

INSERT INTO `analolg_digital_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'dfhgjdyhj', 'fghjfghjfgh', 'Analolg_1805_1.jpg', 'Digital_1805_1.jpg', 'jpg', 'jpg', 'Ordered HTML List', 'http://localhost:8000/input5.php'),
(2, 'dthdfghd', 'dghdgfhd', '', '', '', '', '', ''),
(3, 'dghdgfhdfgh', 'dghdfghdfg', '', '', '', '', '', ''),
(4, 'dfghdfg dgthdfh ', 'ertyherty ', '', '', '', '', '', 'https://www.w3schools.com/html/html_lists.asp'),
(5, 'dgthdfth etyuetyu ', 'yturtyu etyutyu ', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `aqq_bqq_1805`
--

CREATE TABLE `aqq_bqq_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `aqq_bqq_1805`
--

INSERT INTO `aqq_bqq_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'trtyretyeryt', 'etyetyerty', '', '', '', '', '', ''),
(2, 'yuyturyturytuyu', 'ryturyutryurytuyu', '', '', '', '', '', ''),
(3, 'njrtyu yuyu', ' yuyu yuyu', '', '', '', '', '', '');
...
CREATE TABLE `article` (
  ...
  `AID` int(11) NOT NULL,
  `topic1` varchar(40) DEFAULT NULL,
  `topic2` varchar(40) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `article` (`Article_Name`, `AuthorId`, `LastEdited`, `AID`, `topic1`, `topic2`) VALUES
('malloc_calloc1805', 1805, '0000-00-00', 24, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 25, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 26, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 27, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 28, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 29, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 30, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 31, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 32, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 33, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 34, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 35, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 36, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 37, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 38, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 39, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 40, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 41, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 42, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 43, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 44, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 45, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 46, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 47, 'malloc', 'calloc'),
('malloc_calloc1805', 1805, '0000-00-00', 48, 'malloc', 'calloc'),
('_1805', 1805, '0000-00-00', 88, '', ''),
('_1805', 1805, '0000-00-00', 92, '', ''),
('a_b1805', 1805, '0000-00-00', 93, 'a', 'b'),
('a_b1805', 1805, '0000-00-00', 94, 'a', 'b'),
('asas_asb1805', 1805, '0000-00-00', 95, 'asas', 'asb'),
('asas_asb1805', 1805, '0000-00-00', 96, 'asas', 'asb'),
('asas_asb1805', 1805, '0000-00-00', 97, 'asas', 'asb'),
('asas_asb1805', 1805, '0000-00-00', 98, 'asas', 'asb'),
('asas_asb1805', 1805, '0000-00-00', 99, 'asas', 'asb'),
('asas_asb1805', 1805, '0000-00-00', 100, 'asas', 'asb'),
('asas_asb1805', 1805, '0000-00-00', 101, 'asas', 'asb'),
('asasddd_asb1805', 1805, '0000-00-00', 102, 'asasddd', 'asb'),
('asasddd_asb1805', 1805, '0000-00-00', 103, 'asasddd', 'asb'),
('asasddd_asb1805', 1805, '0000-00-00', 104, 'asasddd', 'asb'),
('asasddd_asb1805', 1805, '0000-00-00', 105, 'asasddd', 'asb'),
('asasddd_asb1805', 1805, '0000-00-00', 106, 'asasddd', 'asb'),
('aw_aaaaaa1805', 1805, '0000-00-00', 107, 'aw', 'aaaaaa'),
('aw_aaaaaa1805', 1805, '0000-00-00', 108, 'aw', 'aaaaaa'),
('aw_aaaaaa1805', 1805, '0000-00-00', 109, 'aw', 'aaaaaa'),
('aw_aaaaaa1805', 1805, '0000-00-00', 110, 'aw', 'aaaaaa'),
('aw_aaaaaa1805', 1805, '0000-00-00', 111, 'aw', 'aaaaaa'),
('aw1_aaaaaa1805', 1805, '0000-00-00', 112, 'aw1', 'aaaaaa'),
('aw1_aaaaaa1805', 1805, '0000-00-00', 113, 'aw1', 'aaaaaa'),
('aw1_aaaaaa1805', 1805, '0000-00-00', 114, 'aw1', 'aaaaaa'),
('aw1_aaaaaa1805', 1805, '0000-00-00', 115, 'aw1', 'aaaaaa'),
('aw1_aaaaaa1805', 1805, '0000-00-00', 116, 'aw1', 'aaaaaa'),
('aw1_aaaaaa1805', 1805, '0000-00-00', 117, 'aw1', 'aaaaaa'),
('aw1_aaaaaa1805', 1805, '0000-00-00', 118, 'aw1', 'aaaaaa'),
('aw1_aaaaaa1805', 1805, '0000-00-00', 119, 'aw1', 'aaaaaa'),
('aw1_aaaaaa1805', 1805, '0000-00-00', 120, 'aw1', 'aaaaaa'),
('aw1_aaaaaa1805', 1805, '0000-00-00', 121, 'aw1', 'aaaaaa'),
('aw1_aaaaaa1805', 1805, '0000-00-00', 122, 'aw1', 'aaaaaa'),
('aw1_aaaaaa1805', 1805, '0000-00-00', 123, 'aw1', 'aaaaaa'),
('aw1_aaaaaa1805', 1805, '0000-00-00', 124, 'aw1', 'aaaaaa'),
('aw1_aaaaaa1805', 1805, '0000-00-00', 125, 'aw1', 'aaaaaa'),
('aw1_aaaaaa1805', 1805, '0000-00-00', 126, 'aw1', 'aaaaaa'),
('aw1_aaaaaa1805', 1805, '0000-00-00', 127, 'aw1', 'aaaaaa'),
('a1_b11805', 1805, '0000-00-00', 128, 'a1', 'b1'),
('a1_b11805', 1805, '0000-00-00', 129, 'a1', 'b1'),
('a1_b11805', 1805, '0000-00-00', 130, 'a1', 'b1'),
('a1_b11805', 1805, '0000-00-00', 131, 'a1', 'b1'),
('as_as1805', 1805, '0000-00-00', 132, 'as', 'as'),
('a_a1805', 1805, '0000-00-00', 133, 'a', 'a'),
('gjh_hjjg1805', 1805, '0000-00-00', 134, 'gjh', 'hjjg'),
('a_a1805', 1805, '0000-00-00', 135, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 136, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 137, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 138, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 139, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 140, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 141, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 142, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 143, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 144, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 145, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 146, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 147, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 148, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 149, 'a', 'a'),
('a1_a11805', 1805, '0000-00-00', 150, 'a1', 'a1'),
('a1_a11805', 1805, '0000-00-00', 151, 'a1', 'a1'),
('ss_ss1805', 1805, '0000-00-00', 153, 'ss', 'ss'),
('ss_ss1805', 1805, '0000-00-00', 154, 'ss', 'ss'),
('ss_ss1805', 1805, '0000-00-00', 155, 'ss', 'ss'),
('ss_ss1805', 1805, '0000-00-00', 156, 'ss', 'ss'),
('ss_ss1805', 1805, '0000-00-00', 157, 'ss', 'ss'),
('ss_ss1805', 1805, '0000-00-00', 158, 'ss', 'ss'),
('ss_ss1805', 1805, '0000-00-00', 159, 'ss', 'ss'),
('ss_ss1805', 1805, '0000-00-00', 160, 'ss', 'ss'),
('ss_ss1805', 1805, '0000-00-00', 161, 'ss', 'ss'),
('a_a1805', 1805, '0000-00-00', 162, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 163, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 164, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 165, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 166, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 167, 'a', 'a'),
('a_a1805', 1805, '0000-00-00', 168, 'a', 'a'),
('as_sa1805', 1805, '0000-00-00', 169, 'as', 'sa'),
('as_sa1805', 1805, '0000-00-00', 170, 'as', 'sa'),
('as_sa1805', 1805, '0000-00-00', 171, 'as', 'sa'),
('as_sa1805', 1805, '0000-00-00', 172, 'as', 'sa'),
('as_sa1805', 1805, '0000-00-00', 173, 'as', 'sa'),
('as_sa1805', 1805, '0000-00-00', 174, 'as', 'sa'),
('as_sa1805', 1805, '0000-00-00', 175, 'as', 'sa'),
('aa_aa1805', 1805, '0000-00-00', 176, 'aa', 'aa'),
('aassssss_yhjkhjkhjkkh1805', 1805, '0000-00-00', 177, 'aassssss', 'yhjkhjkhjkkh'),
('aassssss#$@_yhjkhjkhjkkh@#$<p>1805', 1805, '0000-00-00', 178, 'aassssss#$@', 'yhjkhjkhjkkh@#$<p>'),
('aassssss#$@<h1></h1>_yhjkhjkhjkkh@#$<p>1805', 1805, '0000-00-00', 179, 'aassssss#$@<h1></h1>', 'yhjkhjkhjkkh@#$<p>'),
('aassssss#$@<h1></h1>_yhjkhjkhjkkh@#$<p>1805', 1805, '0000-00-00', 180, 'aassssss#$@<h1></h1>', 'yhjkhjkhjkkh@#$<p>'),
('aassssss#$@<h1></h1>_yhjkhjkhjkkh@#$<p>1805', 1805, '0000-00-00', 181, 'aassssss#$@<h1></h1>', 'yhjkhjkhjkkh@#$<p>'),
('sss#$@<h1></h1>_yhjkhjkhjkkh@#$<p></p>1805', 1805, '0000-00-00', 182, 'sss#$@<h1></h1>', 'yhjkhjkhjkkh@#$<p></p>'),
('sss#$@<h1></h1>_yhjkhjkhjkkh@#$<p></p>1805', 1805, '0000-00-00', 183, 'sss#$@<h1></h1>', 'yhjkhjkhjkkh@#$<p></p>'),
('sss#$@<h1>aaaaaaaaaa</h1>_ccc@#$<p>bbbbbb</p>1805', 1805, '0000-00-00', 184, 'sss#$@<h1>aaaaaaaaaa</h1>', 'ccc@#$<p>bbbbbb</p>'),
('sss#$@<h1>aaaaaaaaaa</h1>_ccc@#$<h1>bbbbbb</h>1805', 1805, '0000-00-00', 185, 'sss#$@<h1>aaaaaaaaaa</h1>', 'ccc@#$<h1>bbbbbb</h>'),
('sss#$@<h1>aaaaaaaaaa</h1>_ccc@#$<h1>bbbbbb</h>1805', 1805, '0000-00-00', 186, 'sss#$@<h1>aaaaaaaaaa</h1>', 'ccc@#$<h1>bbbbbb</h>'),
('sss#$@<h1>aaaaaaaaaa</h1>_ccc@#$<h1>bbbbbb</h>1805', 1805, '0000-00-00', 187, 'sss#$@<h1>aaaaaaaaaa</h1>', 'ccc@#$<h1>bbbbbb</h>'),
('sss#$@<h1>aaaaaaaaaa</h1>_ccc@#$<h1>bbbbbb</h>1805', 1805, '0000-00-00', 188, 'sss#$@<h1>aaaaaaaaaa</h1>', 'ccc@#$<h1>bbbbbb</h>'),
('sss#$@<h1>aaaaaaaaaa</h1>_ccc@#$<h1>bbbbbb</h>1805', 1805, '0000-00-00', 189, 'sss#$@<h1>aaaaaaaaaa</h1>', 'ccc@#$<h1>bbbbbb</h>'),
('sss#$@<h1>aaaaaaaaaa</h1>_ccc@#$<h1>bbbbbb</h>1805', 1805, '0000-00-00', 190, 'sss#$@<h1>aaaaaaaaaa</h1>', 'ccc@#$<h1>bbbbbb</h>'),
('sss#$@<h1>aaaaaaaaaa</h1>_ccc@#$<h1>bbbbbb</h>1805', 1805, '0000-00-00', 191, 'sss#$@<h1>aaaaaaaaaa</h1>', 'ccc@#$<h1>bbbbbb</h>'),
('sss#$@<h1>aaaaaaaaaa</h1>_ccc@#$<h1>bbbbbb</h>1805', 1805, '0000-00-00', 192, 'sss#$@<h1>aaaaaaaaaa</h1>', 'ccc@#$<h1>bbbbbb</h>'),
('sss#$@aaaaaaaaaa_ccc@#$1805', 1805, '0000-00-00', 193, 'sss#$@aaaaaaaaaa', 'ccc@#$'),
('sss#$@aaaaaaaaaa_ccc@#$<h1>cghjfgh</h1>1805', 1805, '0000-00-00', 194, 'sss#$@aaaaaaaaaa', 'ccc@#$<h1>cghjfgh</h1>'),
('sss#$@aaaaaaaaaa_ccc@#$<h1>cghjfgh</h1>1805', 1805, '0000-00-00', 195, 'sss#$@aaaaaaaaaa', 'ccc@#$<h1>cghjfgh</h1>'),
('sss#$@aaaaaaaaaa_ccc@#$<h1>cghjfgh</h1>1805', 1805, '0000-00-00', 196, 'sss#$@aaaaaaaaaa', 'ccc@#$<h1>cghjfgh</h1>'),
('sss#$@aaaaaaaaaa_ccc@#$<h1>cghjfgh</h1>1805', 1805, '0000-00-00', 197, 'sss#$@aaaaaaaaaa', 'ccc@#$<h1>cghjfgh</h1>'),
('sss#$@aaaaaaaaaa_ccc@#$<h1>cghjfgh</h1>1805', 1805, '0000-00-00', 198, 'sss#$@aaaaaaaaaa', 'ccc@#$<h1>cghjfgh</h1>'),
('sss#$@aaaaaaaaaa_ccc@#$<h1>cghjfgh</h1>1805', 1805, '0000-00-00', 199, 'sss#$@aaaaaaaaaa', 'ccc@#$<h1>cghjfgh</h1>'),
('aaaaaasdsd_asdada1805', 1805, '0000-00-00', 200, 'aaaaaasdsd', 'asdada'),
('aaaaaasdsd_asdada1805', 1805, '0000-00-00', 201, 'aaaaaasdsd', 'asdada'),
('aaaaaasdsd_asdada1805', 1805, '0000-00-00', 202, 'aaaaaasdsd', 'asdada'),
('aaaaaasdsd_asdada1805', 1805, '0000-00-00', 203, 'aaaaaasdsd', 'asdada'),
('aaaaaasdsd_asdada1805', 1805, '0000-00-00', 204, 'aaaaaasdsd', 'asdada'),
('aaaaaasdsdaa_asdada1805', 1805, '0000-00-00', 205, 'aaaaaasdsdaa', 'asdada'),
('aaaaaasdsdaa_asdada1805', 1805, '0000-00-00', 206, 'aaaaaasdsdaa', 'asdada'),
('aaaaaasdsdaa_asdada1805', 1805, '0000-00-00', 207, 'aaaaaasdsdaa', 'asdada'),
('aaaaaasdsdaa_asdada1805', 1805, '0000-00-00', 208, 'aaaaaasdsdaa', 'asdada'),
('aaaaaasdsdaa_asdada1805', 1805, '0000-00-00', 209, 'aaaaaasdsdaa', 'asdada'),
('aaa_aaa1805', 1805, '0000-00-00', 210, 'aaa', 'aaa'),
('aaa_aaa1805', 1805, '0000-00-00', 211, 'aaa', 'aaa'),
('aaa_aaa1805', 1805, '0000-00-00', 212, 'aaa', 'aaa'),
('aaa_aaa1805', 1805, '0000-00-00', 213, 'aaa', 'aaa'),
('aaa121_gaaa1211805', 1805, '0000-00-00', 214, 'aaa121', 'gaaa121'),
('aaa121<h1>mmm</h1>_gaaa1211805', 1805, '0000-00-00', 215, 'aaa121<h1>mmm</h1>', 'gaaa121'),
('aaa121<h1>mmm</h1>_gaaa1211805', 1805, '0000-00-00', 216, 'aaa121mmm', 'gaaa121'),
('aaa121<h1>mmm</h1>_gaaa1211805', 1805, '0000-00-00', 217, 'aaa121mmm', 'gaaa121'),
('aaa121<h1>mmm</h1>_gaaa1211805', 1805, '0000-00-00', 218, 'aaa121mmm', 'gaaa121'),
('aaa121<h1>mmm</h1>_gaaa1211805', 1805, '0000-00-00', 219, 'aaa121mmm', 'gaaa121'),
('aaa121<h1>mmm</h1>_gaaa1211805', 1805, '0000-00-00', 220, 'aaa121mmm', 'gaaa121'),
('aaa121<h1>mmm</h1>_gaaa1211805', 1805, '0000-00-00', 221, 'aaa121mmm', 'gaaa121'),
('aaa121<h1>mmm</h1>_gaaa1211805', 1805, '0000-00-00', 222, 'aaa121mmm', 'gaaa121'),
('aaa121<h1>mmm</h1>_gaaa1211805', 1805, '0000-00-00', 223, 'aaa121mmm', 'gaaa121'),
('aaa121<h1>mmm</h1>_gaaa1211805', 1805, '0000-00-00', 224, 'aaa121mmm', 'gaaa121'),
('aaa121mmm_gaaa1211805', 1805, '0000-00-00', 225, 'aaa121mmm', 'gaaa121'),
('aaa121mmm_gaaa1211805', 1805, '0000-00-00', 226, 'aaa121mmm', 'gaaa121'),
('aaa121mmm_gaaa1211805', 1805, '0000-00-00', 227, 'aaa121mmm', 'gaaa121'),
('aaa121mmm_gaaa1211805', 1805, '0000-00-00', 228, 'aaa121mmm', 'gaaa121'),
('aaa121mmm_gaaa1211805', 1805, '0000-00-00', 229, 'aaa121mmm', 'gaaa121'),
('aaa121mmm_gaaa1211805', 1805, '0000-00-00', 230, 'aaa121mmm', 'gaaa121'),
('aaa121mmm_gaaa1211805', 1805, '0000-00-00', 231, 'aaa121mmm', 'gaaa121'),
('aaa121mmm_gaaa1211805', 1805, '0000-00-00', 232, 'aaa121mmm', 'gaaa121'),
('aaa121mmm_gaaa1211805', 1805, '0000-00-00', 233, 'aaa121mmm', 'gaaa121'),
('_1805', 1805, '0000-00-00', 234, '', ''),
('_1805', 1805, '0000-00-00', 235, '', ''),
('_1805', 1805, '0000-00-00', 236, '', ''),
('_1805', 1805, '0000-00-00', 237, '', ''),
('_1805', 1805, '0000-00-00', 238, '', ''),
('_1805', 1805, '0000-00-00', 239, '', ''),
('asas_dsds1805', 1805, '0000-00-00', 240, 'asas', 'dsds'),
('asas_dsds1805', 1805, '0000-00-00', 241, 'asas', 'dsds'),
('aa_aa1805', 1805, '0000-00-00', 242, 'aa', 'aa'),
('aa_aa1805', 1805, '0000-00-00', 243, 'aa', 'aa'),
('aa_aa1805', 1805, '0000-00-00', 244, 'aa', 'aa'),
('aa_aa1805', 1805, '0000-00-00', 245, 'aa', 'aa'),
('aa_aa1805', 1805, '0000-00-00', 246, 'aa', 'aa'),
('aa_aa1805', 1805, '0000-00-00', 247, 'aa', 'aa'),
('aa_aa1805', 1805, '0000-00-00', 248, 'aa', 'aa'),
('aa_aa1805', 1805, '0000-00-00', 249, 'aa', 'aa'),
('aa_aa1805', 1805, '0000-00-00', 250, 'aa', 'aa'),
('aa_aa1805', 1805, '0000-00-00', 251, 'aa', 'aa'),
('aa_aa1805', 1805, '0000-00-00', 252, 'aa', 'aa'),
('aaa_aaa1805', 1805, '0000-00-00', 253, 'aaa', 'aaa'),
('aaa_aaa1805', 1805, '0000-00-00', 254, 'aaa', 'aaa'),
('aaa_aaa1805', 1805, '0000-00-00', 255, 'aaa', 'aaa'),
('aaa_aaa1805', 1805, '0000-00-00', 256, 'aaa', 'aaa'),
('aaaa_aaaa1805', 1805, '0000-00-00', 257, 'aaaa', 'aaaa'),
('aaaaa_aaaa1805', 1805, '0000-00-00', 258, 'aaaaa', 'aaaa'),
('aaaaa_aaaa1805', 1805, '0000-00-00', 259, 'aaaaa', 'aaaa'),
('aaaaa_aaaa1805', 1805, '0000-00-00', 260, 'aaaaa', 'aaaa'),
('aaaaa_aaaa1805', 1805, '0000-00-00', 261, 'aaaaa', 'aaaa'),
('aaaaa_aaaa1805', 1805, '0000-00-00', 262, 'aaaaa', 'aaaa'),
('aaaaa_aaaa1805', 1805, '0000-00-00', 263, 'aaaaa', 'aaaa'),
('aaaaa_aaaa1805', 1805, '0000-00-00', 264, 'aaaaa', 'aaaa'),
('aaaaa_aaaa1805', 1805, '0000-00-00', 265, 'aaaaa', 'aaaa'),
('aaaaa_aaaa1805', 1805, '0000-00-00', 266, 'aaaaa', 'aaaa'),
('_1805', 1805, '0000-00-00', 267, '', ''),
('aaaaa_aaaa1805', 1805, '0000-00-00', 268, 'aaaaa', 'aaaa'),
('aaaaa_aaaa1805', 1805, '0000-00-00', 269, 'aaaaa', 'aaaa'),
('aaaaa_aaaa1805', 1805, '0000-00-00', 270, 'aaaaa', 'aaaa'),
('aaaaa_aaaa1805', 1805, '0000-00-00', 271, 'aaaaa', 'aaaa'),
('aaaaa_aaaa_1805', 1805, '0000-00-00', 280, 'aaaaa', 'aaaa'),
('aaaaa_aaaa_1805', 1805, '0000-00-00', 281, 'aaaaa', 'aaaa'),
('a1_ba_1805', 1805, '0000-00-00', 288, 'a1', 'ba'),
('a1_ba_1805', 1805, '0000-00-00', 289, 'a1', 'ba'),
('a1_ba_1805', 1805, '0000-00-00', 290, 'a1', 'ba'),
('a1_ba_1805', 1805, '0000-00-00', 291, 'a1', 'ba'),
('a1_ba_1805', 1805, '0000-00-00', 292, 'a1', 'ba'),
('a1_ba_1805', 1805, '0000-00-00', 293, 'a1', 'ba'),
('a1_ba_1805', 1805, '0000-00-00', 294, 'a1', 'ba'),
('a1_ba_1805', 1805, '0000-00-00', 295, 'a1', 'ba'),
('a11_ba1_1805', 1805, '0000-00-00', 296, 'a11', 'ba1'),
('a11_ba1_1805', 1805, '0000-00-00', 297, 'a11', 'ba1'),
('a111_ba11_1805', 1805, '0000-00-00', 298, 'a111', 'ba11'),
('a111_ba11_1805', 1805, '0000-00-00', 299, 'a111', 'ba11'),
('a111_ba11_1805', 1805, '0000-00-00', 300, 'a111', 'ba11'),
('a111_ba11_1805', 1805, '0000-00-00', 301, 'a111', 'ba11'),
('a1112_ba112_1805', 1805, '0000-00-00', 302, 'a1112', 'ba112'),
('a1112_ba112_1805', 1805, '0000-00-00', 303, 'a1112', 'ba112'),
('a1112_ba112_1805', 1805, '0000-00-00', 304, 'a1112', 'ba112'),
('a21_c12_1805', 1805, '0000-00-00', 305, 'a21', 'c12'),
('a21_c12_1805', 1805, '0000-00-00', 306, 'a21', 'c12'),
('a211_c121_1805', 1805, '0000-00-00', 307, 'a211', 'c121'),
('a211_c121_1805', 1805, '0000-00-00', 308, 'a211', 'c121'),
('a2112_c1212_1805', 1805, '0000-00-00', 309, 'a2112', 'c1212'),
('a2112_c1212_1805', 1805, '0000-00-00', 310, 'a2112', 'c1212'),
('a21121_c12121_1805', 1805, '0000-00-00', 311, 'a21121', 'c12121'),
('a21121_c12121_1805', 1805, '0000-00-00', 312, 'a21121', 'c12121'),
('a211211_c121211_1805', 1805, '0000-00-00', 313, 'a211211', 'c121211'),
('a211211_c121211_1805', 1805, '0000-00-00', 314, 'a211211', 'c121211'),
('a211211_c121211_1805', 1805, '0000-00-00', 315, 'a211211', 'c121211'),
('a211211_c121211_1805', 1805, '0000-00-00', 316, 'a211211', 'c121211'),
('a211211_c121211_1805', 1805, '0000-00-00', 317, 'a211211', 'c121211'),
('a211211_c121211_1805', 1805, '0000-00-00', 318, 'a211211', 'c121211'),
('a211211_c121211_1805', 1805, '0000-00-00', 319, 'a211211', 'c121211'),
('abcd1_abcd2_1805', 1805, '0000-00-00', 320, 'abcd1', 'abcd2'),
('abcd11_abcd22_1805', 1805, '0000-00-00', 321, 'abcd11', 'abcd22'),
('abcd111_abcd221_1805', 1805, '0000-00-00', 322, 'abcd111', 'abcd221'),
('mm1_nn2_1805', 1805, '0000-00-00', 323, 'mm1', 'nn2'),
('mm11_nn22_1805', 1805, '0000-00-00', 324, 'mm11', 'nn22'),
('mm112_nn222_1805', 1805, '0000-00-00', 325, 'mm112', 'nn222'),
('mahi1_nm1_1805', 1805, '0000-00-00', 326, 'mahi1', 'nm1'),
('mahi2_nm2_1805', 1805, '0000-00-00', 327, 'mahi2', 'nm2'),
('mahi2_nm2_1805', 1805, '0000-00-00', 328, 'mahi2', 'nm2'),
('mahi2_nm2_1805', 1805, '0000-00-00', 329, 'mahi2', 'nm2'),
('mahi2_nm2_1805', 1805, '0000-00-00', 330, 'mahi2', 'nm2'),
('mahi2_nm2_1805', 1805, '0000-00-00', 331, 'mahi2', 'nm2'),
('mahi22_nm22_1805', 1805, '0000-00-00', 332, 'mahi22', 'nm22'),
('mahi221_nm221_1805', 1805, '0000-00-00', 333, 'mahi221', 'nm221'),
('mahi221_nm221_1805', 1805, '0000-00-00', 334, 'mahi221', 'nm221'),
('nmnm_asa2_1805', 1805, '0000-00-00', 335, 'nmnm', 'asa2'),
('nmnm_asa2_1805', 1805, '0000-00-00', 336, 'nmnm', 'asa2'),
('awaw_aeaw_1805', 1805, '0000-00-00', 337, 'awaw', 'aeaw'),
('awaw_aeaw_1805', 1805, '0000-00-00', 338, 'awaw', 'aeaw'),
('awaw1_aeaw1_1805', 1805, '0000-00-00', 339, 'awaw1', 'aeaw1'),
('awaw12_aeaw12_1805', 1805, '0000-00-00', 340, 'awaw12', 'aeaw12'),
('awaw123_aeaw123_1805', 1805, '0000-00-00', 341, 'awaw123', 'aeaw123'),
('awaw1234_aeaw1234_1805', 1805, '0000-00-00', 342, 'awaw1234', 'aeaw1234'),
('awaw12345_aeaw12345_1805', 1805, '0000-00-00', 343, 'awaw12345', 'aeaw12345'),
('cv1_vc1_1805', 1805, '0000-00-00', 344, 'cv1', 'vc1'),
('cv1_vc1_1805', 1805, '0000-00-00', 345, 'cv1', 'vc1'),
('cv2_vc2_1805', 1805, '0000-00-00', 346, 'cv2', 'vc2'),
('cv2_vc2_1805', 1805, '0000-00-00', 347, 'cv2', 'vc2'),
('cv2_vc2_1805', 1805, '0000-00-00', 348, 'cv2', 'vc2'),
('cv21_vc21_1805', 1805, '0000-00-00', 349, 'cv21', 'vc21'),
('a1a_b1b_1805', 1805, '0000-00-00', 350, 'a1a', 'b1b'),
('a1b_aswe2_1805', 1805, '0000-00-00', 351, 'a1b', 'aswe2'),
('a121_c123_1805', 1805, '0000-00-00', 352, 'a121', 'c123'),
('m1m_n1n_1805', 1805, '0000-00-00', 353, 'm1m', 'n1n'),
('ma_ba_1805', 1805, '0000-00-00', 354, 'ma', 'ba'),
('csdf_sdf_1805', 1805, '0000-00-00', 355, 'csdf', 'sdf'),
('mahendra _namu_1805', 1805, '0000-00-00', 356, 'mahendra ', 'namu'),
('mahendra _namu_1805', 1805, '0000-00-00', 357, 'mahendra ', 'namu'),
('mahendra _namu_1805', 1805, '0000-00-00', 358, 'mahendra ', 'namu'),
('mahendra _namu_1805', 1805, '0000-00-00', 359, 'mahendra ', 'namu'),
('mahendra _namu_1805', 1805, '0000-00-00', 360, 'mahendra ', 'namu'),
('mahendra _namu_1805', 1805, '0000-00-00', 361, 'mahendra ', 'namu'),
('mahendra1_namu1_1805', 1805, '0000-00-00', 362, 'mahendra1', 'namu1'),
('mahendra_namu_1805', 1805, '0000-00-00', 363, 'mahendra', 'namu'),
('mahendra_namu_1805', 1805, '0000-00-00', 364, 'mahendra', 'namu'),
('mahendra_namu_1805', 1805, '0000-00-00', 365, 'mahendra', 'namu'),
('calloc1_malloc1_1805', 1805, '0000-00-00', 366, 'calloc1', 'malloc1'),
('calloc2_malloc2_1805', 1805, '0000-00-00', 367, 'calloc2', 'malloc2'),
('calloc3_malloc3_1805', 1805, '0000-00-00', 368, 'calloc3', 'malloc3'),
('calloc4_malloc4_1805', 1805, '0000-00-00', 369, 'calloc4', 'malloc4'),
('Malloc5_calloc5_1805', 1805, '0000-00-00', 370, 'Malloc5', 'calloc5'),
('OLAP_OLTP_1805', 1805, '0000-00-00', 371, 'OLAP', 'OLTP'),
('HTML_XML_1805', 1805, '0000-00-00', 372, 'HTML', 'XML'),
('CSS_JS_1805', 1805, '0000-00-00', 373, 'CSS', 'JS'),
('a111111_b111111_1805', 1805, '0000-00-00', 374, 'a111111', 'b111111'),
('e1111_g111111_1805', 1805, '0000-00-00', 375, 'e1111', 'g111111'),
('MAhi_namu_1805', 1805, '0000-00-00', 376, 'MAhi', 'namu'),
('malloc4_calloc4_1805', 1805, '0000-00-00', 377, 'malloc4', 'calloc4'),
('Malloc232_Calloc34_1805', 1805, '0000-00-00', 378, 'Malloc232', 'Calloc34'),
('OLAP1_OLTP1_1805', 1805, '0000-00-00', 379, 'OLAP1', 'OLTP1'),
('OLAP2_OLTP2_1805', 1805, '0000-00-00', 380, 'OLAP2', 'OLTP2'),
('OLAP_OLTP_1805', 1805, '0000-00-00', 381, 'OLAP', 'OLTP'),
('OLAP3_OLTP3_1805', 1805, '0000-00-00', 382, 'OLAP3', 'OLTP3'),
('OLAP4_OLTP4_1805', 1805, '0000-00-00', 383, 'OLAP4', 'OLTP4'),
('asadaaasa_asasasas_1805', 1805, '0000-00-00', 384, 'asadaaasa', 'asasasas'),
('addadadad_adadada_1805', 1805, '0000-00-00', 385, 'addadadad', 'adadada'),
('rgfsdfg_sfdgsfdg_1805', 1805, '0000-00-00', 386, 'rgfsdfg', 'sfdgsfdg'),
('a123_b123_1805', 1805, '0000-00-00', 387, 'a123', 'b123'),
('m1111_n1111_1805', 1805, '0000-00-00', 388, 'm1111', 'n1111'),
('t111_r111_1805', 1805, '0000-00-00', 389, 't111', 'r111'),
('u1111_v222222_1805', 1805, '0000-00-00', 390, 'u1111', 'v222222'),
('w11_q11_1805', 1805, '0000-00-00', 391, 'w11', 'q11'),
('aqq_bqq_1805', 1805, '0000-00-00', 392, 'aqq', 'bqq'),
('gsfdgsg_sfdgsfg_1805', 1805, '0000-00-00', 393, 'gsfdgsg', 'sfdgsfg'),
('Me_She_1805', 1805, '0000-00-00', 394, 'Me', 'She'),
('Me1_She1_1805', 1805, '0000-00-00', 395, 'Me1', 'She1'),
('r11_s11_1805', 1805, '0000-00-00', 396, 'r11', 's11'),
('qhh_retrt_1805', 1805, '0000-00-00', 397, 'qhh', 'retrt'),
('sdfgsfg_fgsfdgwretw_1805', 1805, '0000-00-00', 398, 'sdfgsfg', 'fgsfdgwretw'),
('OLAP5_OLTP5_1805', 1805, '0000-00-00', 399, 'OLAP5', 'OLTP5'),
('UL_OL_1805', 1805, '0000-00-00', 400, 'UL', 'OL'),
('UL1_OL1_1805', 1805, '0000-00-00', 401, 'UL1', 'OL1'),
('UL2_OL2_1805', 1805, '0000-00-00', 402, 'UL2', 'OL2'),
('UL3_OL3_1805', 1805, '0000-00-00', 403, 'UL3', 'OL3'),
('UL4_OL4_1805', 1805, '0000-00-00', 404, 'UL4', 'OL4'),
('UL5_UL5_1805', 1805, '0000-00-00', 405, 'UL5', 'UL5'),
('UL6_OL6_1805', 1805, '0000-00-00', 406, 'UL6', 'OL6'),
('UL6_OL6_1805', 1805, '0000-00-00', 407, 'UL6', 'OL6'),
('UL7_OL7_1805', 1805, '0000-00-00', 408, 'UL7', 'OL7'),
('Analolg_Digital_1805', 1805, '0000-00-00', 409, 'Analolg', 'Digital'),
('asas_asasa_1805', 1805, '0000-00-00', 410, 'asas', 'asasa'),
('Calloc_Malloc_1805', 1805, '0000-00-00', 411, 'Calloc', 'Malloc'),
('OLTP_OLAP_1805', 1805, '0000-00-00', 412, 'OLTP', 'OLAP'),
('aASDASD_ASDAsd_1805', 1805, '2000-02-01', 413, 'aASDASD', 'ASDAsd'),
('yttyfyytcyry_rdyuttut vuu_1805', 1805, '0000-00-00', 414, 'yttyfyytcyry', 'rdyuttut vuu'),
('asasasas_qerwerwer_1805', 1805, '0000-00-00', 415, 'asasasas', 'qerwerwer'),
('ertertq_etqetqe_1805', 1805, '0000-00-00', 416, 'ertertq', 'etqetqe'),
('db_dmw_1805', 1805, '0000-00-00', 417, 'db', 'dmw'),
('Extrinsic_GEUGudf_1805', 1805, '0000-00-00', 418, 'Extrinsic', 'GEUGudf'),
('eriaer ieruiu_oauiero _1805', 1805, '0000-00-00', 419, 'eriaer ieruiu', 'oauiero '),
('sdrrt_srtwert_1805', 1805, '0000-00-00', 420, 'sdrrt', 'srtwert'),
('Structure_Union_1805', 1805, '0000-00-00', 421, 'Structure', 'Union'),
('Formal Parameter_Actual Parameter_1805', 1805, '0000-00-00', 422, 'Formal Parameter', 'Actual Parameter'),
('Formal Parameter_Actual Parameter_1805', 1805, '0000-00-00', 423, 'Formal Parameter', 'Actual Parameter'),
('__1805', 1805, '0000-00-00', 424, '', ''),
('__1805', 1805, '0000-00-00', 425, '', ''),
('asdasdasdasd_awewerwerer_1805', 1805, '0000-00-00', 426, 'asdasdasdasd', 'awewerwerer'),
('Formal Parameters_Actual Parameters_1805', 1805, '0000-00-00', 427, 'Formal Parameters', 'Actual Parameters'),
('Formal_Actual_1805', 1805, '0000-00-00', 428, 'Formal', 'Actual'),
('wert_qwer_1805', 1805, '0000-00-00', 429, 'wert', 'qwer'),
('malloc()_calloc()_1805', 1805, '0000-00-00', 430, 'malloc()', 'calloc()'),
('malloc_calloc_1805', 1805, '0000-00-00', 431, 'malloc', 'calloc');

-- --------------------------------------------------------

--
-- Table structure for table `articlen`
--

CREATE TABLE `articlen` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(15) DEFAULT NULL,
  `imgname2` varchar(15) DEFAULT NULL,
  `imgtype1` varchar(5) DEFAULT NULL,
  `imgtype2` varchar(5) DEFAULT NULL,
  `referencename` text,
  `referenceurl` text
...
--
-- Table structure for table `articlen2`
--

CREATE TABLE `articlen2` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(15) DEFAULT NULL,
...
--
-- Table structure for table `asadaaasa_asasasas_1805`
--

CREATE TABLE `asadaaasa_asasasas_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `asadaaasa_asasasas_1805`
--

INSERT INTO `asadaaasa_asasasas_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'rytwret', 'eyttry', '', '', '', '', '', ''),
(2, 'eyteyt eytert', ' rtyeryter rtyerty', '', '', '', '', '', ''),
(3, 'ertyeryt ty etyurtyu ', 'yturtyu tyuy rtrtyery rtyery', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `asasasas_qerwerwer_1805`
--

CREATE TABLE `asasasas_qerwerwer_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `asasasas_qerwerwer_1805`
--

INSERT INTO `asasasas_qerwerwer_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'wejkwejhk', 'kjWKEKEH', '', '', '', '', '', ''),
(2, 'KEJHFKHE', 'KJKWEWKEH', '', '', '', '', '', ''),
(3, 'AJFwehrfJWERJK', 'LWKELJwelfkjKLWE', '', '', '', '', '', ''),
(4, 'LWEKJlwejr', 'lKJWELJLwejrl', '', '', '', '', '', ''),
(5, 'lwkejrLWEJRL', 'LKLW', '', '', '', '', '', ''),
(6, 'KWEJKWLER', 'LKEFjwelrjLWER', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `asas_asasa_1805`
--

CREATE TABLE `asas_asasa_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `asas_asasa_1805`
--

INSERT INTO `asas_asasa_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'fgfgfdg', 'rtrtwert', '', '', '', '', '', ''),
(2, 'ertret', 'wretwretw', '', '', '', '', '', ''),
(3, 'wretwert', 'wrtwretwert', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `asdasdasdasd_awewerwerer_1805`
--

CREATE TABLE `asdasdasdasd_awewerwerer_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `asdasdasdasd_awewerwerer_1805`
--

INSERT INTO `asdasdasdasd_awewerwerer_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'grt ty45y', '56 56y56y', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `calloc_malloc_1805`
--

CREATE TABLE `calloc_malloc_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `calloc_malloc_1805`
--

INSERT INTO `calloc_malloc_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'ddfgh trtry cvvbvb    fggh fghdfgh dghdfg ', 'sfh fghfhg fghdfgh fghdfgh sfdsdfg', '', '', '', '', '', ''),
(2, 'etyery  ytuytu tryetry tryrety ', 'wtryyt tyty rtyety etyerty ytry ', '', '', '', '', '', ''),
(3, 'tyety etyueb tyerty etyerty wrtywrty', 'rtyeyt etyety tyerty rtyerty etyrty ytry', '', '', '', '', '', ''),
(4, 'tryeryt tyeyt uyrtyu yurytu ryuryu', 'yturytu yuruy yturtyu ryuryu ryuryury ryuryu yuryu', '', '', '', '', '', ''),
(5, 'rytur ryuryu ryuryu ryuryu ruyryu ryurtyu yuryu', 'ryturyu yuryu yuruy ryurtyu yurytu ryuryu ryuyu', '', '', '', '', '', ''),
(6, 'thdfgh yturyu yuryu yturyu ryuyu', ' yturyu ryurtyu yuruy yuryu ruyruy ryuyu yuryu uryu yuryu', '', '', '', '', '', ''),
(7, 'tyuryu ryuiruy yturyu ryuryu ry', ' ruyrtyu rtuyryu ryuryu ryuruy ryuryu', '', '', '', '', '', '');
...
--
-- Table structure for table `csdf_sdf_1805`
--

CREATE TABLE `csdf_sdf_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `csdf_sdf_1805`
--

INSERT INTO `csdf_sdf_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'rfg', 'sdfgsdfg', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `css_js_1805`
--

CREATE TABLE `css_js_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `css_js_1805`
--

INSERT INTO `css_js_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'erterty', 'rytirtyui', '', '', '', '', '', ''),
(2, 'ryiruirt', 'bg7yuryt fuyi', '', '', '', '', '', ''),
(3, 'fyukuyk', 'hjfgj', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `cv1_vc1_1805`
--

CREATE TABLE `cv1_vc1_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `cv1_vc1_1805`
--

INSERT INTO `cv1_vc1_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'aaaaaaaaaaaaa', 'aaaaaaaaaaaaaaa', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `cv2_vc2_1805`
--

CREATE TABLE `cv2_vc2_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `cv2_vc2_1805`
--

INSERT INTO `cv2_vc2_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'gngfhdgfh', 'dgfhgh dtghdgh', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `cv21_vc21_1805`
--

CREATE TABLE `cv21_vc21_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `cv21_vc21_1805`
--

INSERT INTO `cv21_vc21_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'gngfhdgfh', 'dgfhgh dtghdgh', '', '', '', '', '', '');
...
('::1', 'codeworld', 'root', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y');

-- --------------------------------------------------------

--
-- Table structure for table `db_dmw_1805`
--

CREATE TABLE `db_dmw_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `db_dmw_1805`
--

INSERT INTO `db_dmw_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'iqeruiqu joerut', 'iuqerit khqierut', '', '', '', '', '', ''),
(2, 'iqeryty yqieyrptu iuqpuert yuqert ', 'iwerito uqert uqert ', '', '', '', '', '', ''),
(3, 'iuhqeirhiihqerth iquerit', 'hqerhlq uqeruty', '', '', '', '', '', ''),
(4, 'iqu4itr halrther', 'iqweyriuyiwer qertqwer', '', '', '', '', '', ''),
(5, 'iauyeiryiq yqywer uyqwer', 'uwrethi hertiy hret', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `e1111_g111111_1805`
--

CREATE TABLE `e1111_g111111_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `e1111_g111111_1805`
--

INSERT INTO `e1111_g111111_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'yurtyu', 'yurtyujryuk', '', '', '', '', '', ''),
(2, 'rtytry', 'tgtyrty', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `ertertq_etqetqe_1805`
--

CREATE TABLE `ertertq_etqetqe_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `ertertq_etqetqe_1805`
--

INSERT INTO `ertertq_etqetqe_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'qwerqwer', 'qwerqwer', '', '', '', '', '', ''),
(2, 'qwetqrt', 'wrtwert', '', '', '', '', '', ''),
(3, 'tywrtgw', 'wrtgwrtwert', '', '', '', '', '', ''),
(4, 'aerger', 'rtwertwert', '', '', '', '', '', '');
...
--
-- Table structure for table `extrinsic_geugudf_1805`
--

CREATE TABLE `extrinsic_geugudf_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `extrinsic_geugudf_1805`
--

INSERT INTO `extrinsic_geugudf_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'ihfayhiefq kajefqyweiu iuqyweuir', 'oUEORUQOE IWEYRIY', 'Extrinsic_1805_1.jpg', 'GEUGudf_1805_1.jpg', 'jpg', 'jpg', '', ''),
(2, 'JDFH IUAOERU UQOEUR', 'OUERO UOQUR OUOQ4R', '', '', '', '', '', ''),
(3, 'IQEYWRIY IYQIEWRY JQEWR', 'IQUEIRU IQER OUOQWER', '', '', '', '', '', ''),
(4, 'kJDSHFK IAISDF IHAE', 'QIERUOU AJSDFA liwerot  orot ojrt', '', '', '', '', '', ''),
(5, 'sdri iuor iouor ', 'wouiertu ouwoert oujowert', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `formal_actual_1805`
--

CREATE TABLE `formal_actual_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `formal_actual_1805`
--

INSERT INTO `formal_actual_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'An ordered list of parameters which are included at the time of definition of function.', 'These are ordered list of parameters which are included at the time of function call.', '', '', '', '', 'https://en.wikipedia.org/wiki/Parameter_(computer_programming)', 'https://en.wikipedia.org/wiki/Parameter_(computer_programming)'),
(2, 'Data types needs to be mentioned.', 'Data type not required. But data type should match with corresponding data type of formal parameters.', '', '', '', '', 'https://overiq.com/c-programming-101/actual-and-formal-arguments-in-c/', 'https://overiq.com/c-programming-101/actual-and-formal-arguments-in-c/'),
(3, 'These are variables with their data type.', 'these can be variables, expression and constant without data types.', 'Formal_1805_3.png', 'Actual_1805_3.png', 'png', 'png', 'https://www.geeksforgeeks.org/parameter-passing-techniques-in-c-cpp/', 'https://www.geeksforgeeks.org/parameter-passing-techniques-in-c-cpp/'),
(4, 'These are only definition of inputs data types. These are to  shows which type of data should be given as input while calling the function. ', 'These are actual values which are given as input to the called function.', '', '', '', '', '', '');
...
--
-- Table structure for table `gjh_hjjg1805`
--

CREATE TABLE `gjh_hjjg1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(15) DEFAULT NULL,
...
--
-- Table structure for table `gsfdgsg_sfdgsfg_1805`
--

CREATE TABLE `gsfdgsg_sfdgsfg_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `gsfdgsg_sfdgsfg_1805`
--

INSERT INTO `gsfdgsg_sfdgsfg_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'fdgsdfg', 'sdfgsfgsdg', '', '', '', '', '', ''),
(2, 'sdfgsdfgs', 'sfgsgsdg', '', '', '', '', '', '');
...
--
-- Table structure for table `m1111_n1111_1805`
--

CREATE TABLE `m1111_n1111_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `m1111_n1111_1805`
--

INSERT INTO `m1111_n1111_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'qetrqewr', 'w5tywert', '', '', '', '', '', ''),
(2, 'wertwert', 'j5uyjyth', '', '', '', '', '', ''),
(3, '67u46h', '46u456h', '', '', '', '', '', '');
...
--
-- Table structure for table `mahi1_nm1_1805`
--

CREATE TABLE `mahi1_nm1_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(15) DEFAULT NULL,
...
--
-- Dumping data for table `mahi1_nm1_1805`
--

INSERT INTO `mahi1_nm1_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, '', 'Hello Nm', 'mahi1_1805_1.jp', 'nm1_1805_1.jpg', 'jpg', 'png', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `mahi2_nm2_1805`
--

CREATE TABLE `mahi2_nm2_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(15) DEFAULT NULL,
...
--
-- Dumping data for table `mahi2_nm2_1805`
--

INSERT INTO `mahi2_nm2_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'Hello Mahendra', 'Hello Nm', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `mahi22_nm22_1805`
--

CREATE TABLE `mahi22_nm22_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(15) DEFAULT NULL,
...
--
-- Dumping data for table `mahi22_nm22_1805`
--

INSERT INTO `mahi22_nm22_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'Hello Mahendra', 'Hello Nm', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `mahi221_nm221_1805`
--

CREATE TABLE `mahi221_nm221_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(15) DEFAULT NULL,
...
--
-- Dumping data for table `mahi221_nm221_1805`
--

INSERT INTO `mahi221_nm221_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'Hello Mahendra', 'Hello Nm', 'mahi221_1805_1.', 'nm221_1805_1.pn', 'png', 'jpg', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `mahi_namu_1805`
--

CREATE TABLE `mahi_namu_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `mahi_namu_1805`
--

INSERT INTO `mahi_namu_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'rtyutry', 'etryeryt', '', '', '', '', '', ''),
(2, 'etytry', 'etryrety', '', '', '', '', '', '');
...
--
-- Table structure for table `malloc1_calloc11805`
--

CREATE TABLE `malloc1_calloc11805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(15) DEFAULT NULL,
...
--
-- Table structure for table `malloc4_calloc4_1805`
--

CREATE TABLE `malloc4_calloc4_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `malloc4_calloc4_1805`
--

INSERT INTO `malloc4_calloc4_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'tryetry', 'yutyu', '', '', '', '', '', ''),
(2, 'tyuetu', 'ytutyu', '', '', '', '', '', '');
...
--
-- Table structure for table `malloc5_calloc5_1805`
--

CREATE TABLE `malloc5_calloc5_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `malloc5_calloc5_1805`
--

INSERT INTO `malloc5_calloc5_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'rtywerywery', 'eyuertuyrty', '', '', '', '', '', ''),
(2, 'rtyhtyhet', 'gfhghertuh', '', '', '', '', '', ''),
(3, 'rt6uyu', 'ghjyguety', '', '', '', '', '', ''),
(4, 'teyutru', 'eytujertu', '', '', '', '', '', '');
...
--
-- Table structure for table `malloc232_calloc34_1805`
--

CREATE TABLE `malloc232_calloc34_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `malloc232_calloc34_1805`
--

INSERT INTO `malloc232_calloc34_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'rtwret', 'wtrywryt', '', '', '', '', '', ''),
(2, 'wertwert', 'wrywert', '', '', '', '', '', ''),
(3, 'wrtywert', 'wrtywrty', '', '', '', '', '', '');
...
--
-- Table structure for table `malloc_calloc1805`
--

CREATE TABLE `malloc_calloc1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(15) DEFAULT NULL,
...
--
-- Table structure for table `malloc_calloc_1805`
--

CREATE TABLE `malloc_calloc_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `malloc_calloc_1805`
--

INSERT INTO `malloc_calloc_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'malloc() does not initializes the allocated memory.', 'calloc() initializes all bytes of allocated memory.', '', '', '', '', 'https://en.wikipedia.org/wiki/C_dynamic_memory_allocation', 'https://en.wikipedia.org/wiki/C_dynamic_memory_allocation'),
(2, 'Default value of allocated memory is garbage value.', 'Default value of allocated memory is 0.', '', '', '', '', 'https://www.dipmat.univpm.it/~demeio/public/the_c_programming_language_2.pdf', 'https://www.dipmat.univpm.it/~demeio/public/the_c_programming_language_2.pdf'),
(3, 'malloc() takes only one argument/input to allocate memory which is number of bytes memory to be allocated. ', 'calloc () takes two arguments/inputs.\r\nFirst one is number of memory to be allocated and second one is the size of each memory.', '', '', '', '', 'http://cs-fundamentals.com/tech-interview/c/difference-between-malloc-and-calloc.php', 'http://cs-fundamentals.com/tech-interview/c/difference-between-malloc-and-calloc.php'),
(4, 'Function prototype:\r\nvoid *malloc(size_t n);\r\nExample:\r\nint  *ptr;\r\nptr=(int*)  malloc(5*sizeof(int));\r\n// it will allocate memory of 5 time of size of int data type.', 'Function prototype:\r\nvoid *calloc(size_t  n, size_t  size);\r\nExample:\r\nint *ptr;\r\nptr=(int *) calloc(10, size(int));\r\n// it will allocate memory to store array of 10 int values.', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `me1_she1_1805`
--

CREATE TABLE `me1_she1_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `me1_she1_1805`
--

INSERT INTO `me1_she1_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'wretwret', 'rtwret', '', '', '', '', '', ''),
(2, 'wretwret', 'btryrty', '', '', '', '', '', ''),
(3, 'rtyyt', 'eetyuet', '', '', '', '', '', ''),
(4, 'tryyt', 'betryerty', '', '', '', '', '', '');
...
--
-- Table structure for table `me_she_1805`
--

CREATE TABLE `me_she_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `me_she_1805`
--

INSERT INTO `me_she_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'hjhjhj', 'ryuyu', '', '', '', '', '', ''),
(2, 'tyuetryeryt', 'ertyetry', '', '', '', '', '', ''),
(3, 'retwrt rtyrety rtyrty etyuetyu etyutey etryutr', ' rtwert rtyrytw wrytwrytw etyuetrywr e6ueryt q34543r  y56345', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `mm1_nn2_1805`
--

CREATE TABLE `mm1_nn2_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(15) DEFAULT NULL,
...
--
-- Table structure for table `mm11_nn22_1805`
--

CREATE TABLE `mm11_nn22_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(15) DEFAULT NULL,
...
--
-- Dumping data for table `mm11_nn22_1805`
--

INSERT INTO `mm11_nn22_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'mm11', 'nn22', 'mm11_1805_1.jpg', 'nn22_1805_1.jpg', 'jpg', 'png', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `mm112_nn222_1805`
--

CREATE TABLE `mm112_nn222_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(15) DEFAULT NULL,
...
--
-- Dumping data for table `mm112_nn222_1805`
--

INSERT INTO `mm112_nn222_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'mm112', 'nn222', 'mm112_1805_1.jp', 'nn222_1805_1.jp', 'jpg', 'png', '', '');
...
--
-- Table structure for table `nmnm_asa2_1805`
--

CREATE TABLE `nmnm_asa2_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(15) DEFAULT NULL,
...
--
-- Dumping data for table `nmnm_asa2_1805`
--

INSERT INTO `nmnm_asa2_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'sgtfhsfdg', 'sfdgsfg', '', '', '', '', '', '');
...
(19, '1+919582429861', 699588, 0);

-- --------------------------------------------------------

--
-- Table structure for table `olap1_oltp1_1805`
--

CREATE TABLE `olap1_oltp1_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `olap1_oltp1_1805`
--

INSERT INTO `olap1_oltp1_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'fghdftgh', 'dghjdgfh', '', '', '', '', '', ''),
(2, 'dfghfdgh', 'dghdfgh', '', '', '', '', '', ''),
(3, 'ghdfghd', 'dghdgh', '', '', '', '', '', ''),
(4, 'mahendra', 'gupta', NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `olap2_oltp2_1805`
--

CREATE TABLE `olap2_oltp2_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `olap2_oltp2_1805`
--

INSERT INTO `olap2_oltp2_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'OLAP stands for Online Analytical Processing.', 'OLTP stands for Online Transaction Processing.', 'OLAP2_1805_1.jpg', 'OLTP2_1805_1.jpg', 'jpg', 'jpg', '', ''),
(2, 'Main objective is to analyse the data.', 'Objective is to make day to day transactions.', '', '', '', '', '', ''),
(3, 'Its size is large.( Few GB to TB)', 'Its is is low.(Few MB to Few GB).', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `olap3_oltp3_1805`
--

CREATE TABLE `olap3_oltp3_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `olap3_oltp3_1805`
--

INSERT INTO `olap3_oltp3_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'ag hkdfh khadf khkiadsf jadsf jfg fgd tjghjdgjh trerty yuryt. tryret brtyeyu ytur yuytutu uiotuy 567 ytur.', 'wirhlhil iwret ufd ouwr uort up9wurt upwret ;oupwre up9wtr u kher ret jujk,h', 'OLAP3_1805_1.jpg', 'OLTP3_1805_1.jpg', 'jpg', 'jpg', '', ''),
(2, 'tryetry etyueu6t ruyrytu ry7uiryui yurytu ', 'rtyturytu r78768 r78i76r8 yuiu fyruiry fgjhy fgyjhn', '', '', '', '', '', ''),
(3, 'owrotuo ;ouoret i[ &#39;pip&#39;iret iper  ty ouio[ty i[t jo[  ihirf oer', 'gerug ugwret urth hrit hir ;jowet irt iwret  trytry try ty rty ', '', '', '', '', '', ''),
(4, 'frty yuyuytuey ytu tyu ytutyuj ', 'etyuertyuetyu ytryu', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `olap4_oltp4_1805`
--

CREATE TABLE `olap4_oltp4_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `olap4_oltp4_1805`
--

INSERT INTO `olap4_oltp4_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'rtyrty ryurytut tyuy', 'retyerty tyutryu ', '', '', '', '', '', ''),
(2, 'hrth hqret h;ret io;re  jfn yuaor kutre ktyert', 'i4oyyiret glwre gle4tr queri qieiryi lhrlth hreth ,lrht lhert ,bjrtl hgwlerthlhw;rt', '', '', '', '', '', ''),
(3, 'w4etrhi iwret iwret iwhret lhwret', ' wrty rty rty rty rty tyu uy 6y', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `olap5_oltp5_1805`
--

CREATE TABLE `olap5_oltp5_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `olap5_oltp5_1805`
--

INSERT INTO `olap5_oltp5_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'wrtywert', 'wrtwrt', '', '', '', '', '', ''),
(2, 'wertwret', 'wretwretwe', 'OLAP5_1805_2.jpg', 'OLTP5_1805_2.jpg', 'jpg', 'jpg', '', ''),
(3, 'e5w5t ', 'wrt5ywrt w  5tw45643 bnf wrwet5w', '', '', '', '', '', ''),
(4, '455q4513 534564', 'v  2422 3634564', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `olap_oltp_1805`
--

CREATE TABLE `olap_oltp_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `olap_oltp_1805`
--

INSERT INTO `olap_oltp_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'Online Analytical Processing.', 'Online Transaction Processing.', '', '', '', '', '', ''),
(2, 'dehgedfgh', 'srethyertyue', '', '', '', '', '', ''),
(3, 'dtyurty ', 'hgjfghj ', '', '', '', '', '', ''),
(4, 'detrguhet tyur ', ' eytu  etyu ', '', '', '', '', '', ''),
(5, 'mahendra', 'gupta', NULL, NULL, NULL, NULL, NULL, NULL),
(6, 'mahendra', 'gupta', NULL, NULL, NULL, NULL, NULL, NULL),
(7, 'mahendra', 'gupta', NULL, NULL, NULL, NULL, NULL, NULL),
(8, 'mahendra', 'gupta', NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `oltp_olap_1805`
--

CREATE TABLE `oltp_olap_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `oltp_olap_1805`
--

INSERT INTO `oltp_olap_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'ttryert etyuety rtyyrty etytry', 'etryerty tyetry etyuety', '', '', '', '', '', ''),
(2, 'tryeyt etyety eterty', 'rtyert euytuy tyurtyu euyet', '', '', '', '', 'ddsfh', 'tuetuyeutyueut'),
(3, 'rtywreyt yurtyu ryurtyu', 'etye yurtuy ryury rtyuryu ', '', '', '', '', 'tyeryte', 'rtyryter'),
(4, 'rtyrytetryrt tryeryt', 'rtyeryt yu rtyu eutruy rtyuy ', '', '', '', '', '', ''),
(5, 'etyuyeryt', 'etyurty', '', '', '', '', '', ''),
(6, 'tyueyt tryuy', 'ytuetu ryuy', '', '', '', '', '', ''),
(7, 'tyuuy tuitu', 'etuety tyurtyu uy', '', '', '', '', '', '');
...
--
-- Table structure for table `qhh_retrt_1805`
--

CREATE TABLE `qhh_retrt_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `qhh_retrt_1805`
--

INSERT INTO `qhh_retrt_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'retrt', 'ytrwtywert', '', '', '', '', '', ''),
(2, 'wtrywertq ip4p uq4  0i45 80[845m9mwytm uretniyert', 'qerilyi  iuotr4 yqewr iuqer ououqerow uq4erp8u0mq4 uoqu4o ououq4m ', '', '', '', '', '', ''),
(3, 'werout r4toiyirn ilyiretnilyrt uort rtyiy jdyty wryw wrtwrt ertw ', ' w5rwrt e6uyet etyer wertwe ert wert wytwrtg qretwe wretwe', '', '', '', '', '', ''),
(4, 'rytp9 ypr9r urt', 'reter wertqret', '', '', '', '', '', '');
...
--
-- Table structure for table `r11_s11_1805`
--

CREATE TABLE `r11_s11_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `r11_s11_1805`
--

INSERT INTO `r11_s11_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'ertwret', 'wrtrt', '', '', '', '', '', ''),
(2, 'wretwert', '3563546', '', '', '', '', '', ''),
(3, 'srdfg5354yv546', 'ty5546 56546', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `rgfsdfg_sfdgsfdg_1805`
--

CREATE TABLE `rgfsdfg_sfdgsfdg_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `rgfsdfg_sfdgsfdg_1805`
--

INSERT INTO `rgfsdfg_sfdgsfdg_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'sfdgsfdg', 'sfdgsfdg', '', '', '', '', '', ''),
(2, 'sdfgsfdg', 'rtywret', '', '', '', '', '', ''),
(3, 'wertgbre', 'trtwrgt', '', '', '', '', '', '');
...
--
-- Table structure for table `sasd_dasd1805`
--

CREATE TABLE `sasd_dasd1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(15) DEFAULT NULL,
...
--
-- Table structure for table `sdfgsfg_fgsfdgwretw_1805`
--

CREATE TABLE `sdfgsfg_fgsfdgwretw_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `sdfgsfg_fgsfdgwretw_1805`
--

INSERT INTO `sdfgsfg_fgsfdgwretw_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'swrtwret', 'tyertyert nbu4y ', 'sdfgsfg_1805_1.jpg', 'fgsfdgwretw_1805_1.jpg', 'jpg', 'jpg', '', ''),
(2, 'wrotoyupio  iyiwryeti', 'ortouoprut uprt4upwqrut uopuroptu upouprt', '', '', '', '', '', ''),
(3, 'rutpouoprutp uo;wruto', 'rtrtpyiuyrtip hlrhtlhpy', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `sdrrt_srtwert_1805`
--

CREATE TABLE `sdrrt_srtwert_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `sdrrt_srtwert_1805`
--

INSERT INTO `sdrrt_srtwert_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'ouiwrtert iusrdt', 'woertuoo', '', '', '', '', '', ''),
(2, 'iuyrt iuwirety', 'woeriutouert ', '', '', '', '', '', ''),
(3, 'iuret ithououo iouwoierut', 'kwrut iuwourt ouowtr', '', '', '', '', '', ''),
(4, 'owjireotu iwuerit ouiwort', 'woeruitou owerotuo jowtr', '', '', '', '', '', '');
...
--
-- Table structure for table `ss_ss1805`
--

CREATE TABLE `ss_ss1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(15) DEFAULT NULL,
...
--
-- Table structure for table `structure_union_1805`
--

CREATE TABLE `structure_union_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `structure_union_1805`
--

INSERT INTO `structure_union_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'Structure is a user defined data structure which can store different types of data  into a single name.', 'Union is also a user defined data type which stores different types of data but one at a time.', '', '', '', '', 'https://www.geeksforgeeks.org/union-c/', 'https://www.geeksforgeeks.org/union-c/'),
(2, 'All of its members have different memory locations.', 'All of its member share same memory location.', '', '', '', '', 'https://en.wikipedia.org/wiki/Union_type#C/C++', 'https://en.wikipedia.org/wiki/Union_type#C/C++'),
(3, 'Size of memory allocated is equal to the sum of all its members.', 'Size of memory allocated is equal to the size of largest members.', '', '', '', '', '', ''),
(4, 'All members can be stored at any point of time.', 'Only one member can be stored at any point of time.', '', '', '', '', '', ''),
(5, 'It uses struct keyword to define a structure variable.', 'It uses union keyword to define a union variable.\r\n', '', '', '', '', '', ''),
(6, '\r\n\r\nstruct student\r\n{\r\n      char  name[15];  // 15 bytes  \r\n      int rollnumber;    // 4bytes\r\n      int marks;           // 4 bytes\r\n}\r\nTotal  15+4+4=23 Bytes memory will be allocated to student variable.\r\nAnd all the members name, rollnumber and marks can be stored.\r\n\r\n', '\r\n\r\nunion student\r\n{\r\n      char  name[15];  // 15 bytes  \r\n      int rollnumber;    // 4bytes\r\n      int marks;           // 4 bytes\r\n}\r\nTotal  max(15+4+4)=15 Bytes memory will be allocated to student variable.\r\nAny one of name, rollnumber and marks  can be stored at at time.\r\n\r\n', '', '', '', '', '', ''),
(7, '', '', 'Structure_1805_7.jpg', 'Union_1805_7.png', 'jpg', 'png', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `t111_r111_1805`
--

CREATE TABLE `t111_r111_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `t111_r111_1805`
--

INSERT INTO `t111_r111_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'wrtwsrt', 'wertwret', '', '', '', '', '', ''),
(2, 'wertwrt', 'rtyurtyu', '', '', '', '', '', ''),
(3, 'grtyryt', 'eryher tyu4', '', '', '', '', '', '');
...
INSERT INTO `test` (`topic1`, `topic2`) VALUES
('hnKHDFKHSDFADSF', 'Hdfjkghjkdshfjg'),
('hnKHDFKHSDFADSF', 'Hdfjkghjkdshfjg'),
('hnKHDFKHSDFADSF', 'Hdfjkghjkdshfjg');
...
INSERT INTO `testdb` (`uname`, `email`) VALUES
('mahendra', 'mahi@gmail.com'),
('mahendra', 'mahi@gmail.com'),
('mahendra', 'mahi@gmail.com'),
('mahendra', 'mahi@gmail.com'),
('mahendra', 'mahi@gmail.com'),
...
--
-- Table structure for table `u1111_v222222_1805`
--

CREATE TABLE `u1111_v222222_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `u1111_v222222_1805`
--

INSERT INTO `u1111_v222222_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'ertyyt', 'ertyty', '', '', '', '', '', ''),
(2, 'eryteryt', 'erytrty', '', '', '', '', '', ''),
(3, 'utyueyt', 'wrtwrt', '', '', '', '', '', '');
...
--
-- Table structure for table `ul1_ol1_1805`
--

CREATE TABLE `ul1_ol1_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `ul1_ol1_1805`
--

INSERT INTO `ul1_ol1_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'Ordered List', 'Ordered List', '', '', '', '', 'https://www.w3schools.com', 'https://www.w3schools.com/html/html_lists.asp'),
(2, 'araqret yetyu', 'eytueu ytujteyu ytujtyu dyuetu', '', '', '', '', '', 'https://www.w3schools.com/html/tryit.asp?filename=tryhtml_lists_unordered_none'),
(3, 'iqeifhi qeiru uquer uqoert', 'retyiqyu uuqerou uopquert uouert jore', '', '', '', '', 'Differencing.org', '');

-- --------------------------------------------------------

--
-- Table structure for table `ul2_ol2_1805`
--

CREATE TABLE `ul2_ol2_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `ul2_ol2_1805`
--

INSERT INTO `ul2_ol2_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'jretkbkhr hretlhq retuoi iuyrt ouwort uwrot uwort', 'pwriytp[m  i[pwirt ipwirt', '', '', '', '', 'Differencing.org', 'http://localhost:8000/input5.php'),
(2, 'erfiiryewp uqertp uqoewur upqer ', 'qoeruo[ ouoqer uopre uwrt ;ouowret ;wert i uowru uowr', '', '', '', '', '', 'https://www.w3schools.com/html/html_lists.asp'),
(3, 'wrtouporuit ouerupto upuret pwurpt uopwret ', 'opureot uowurt uwrt', '', '', '', '', 'Differencing.org', '');

-- --------------------------------------------------------

--
-- Table structure for table `ul3_ol3_1805`
--

CREATE TABLE `ul3_ol3_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `ul3_ol3_1805`
--

INSERT INTO `ul3_ol3_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'rtqot urotuo u wroit uort', 'w;oreutou uowert ouowret uwret uoert uowre', '', '', '', '', 'Differencing.org', 'http://localhost:8000/input5.php'),
(2, 'retuopueropt uoreuto urt', 'yuqier iyilyqe liyiwrn lir u;owtr u', '', '', '', '', 'Differencing.org', '');

-- --------------------------------------------------------

--
-- Table structure for table `ul4_ol4_1805`
--

CREATE TABLE `ul4_ol4_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `ul4_ol4_1805`
--

INSERT INTO `ul4_ol4_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'lrtlqreht fgt liywrit yiret liyire ', 'qutr4 uor uwetr4 uwret uwrt uwrt ', '', '', '', '', 'Differencing.org', 'http://localhost:8000/input5.php'),
(2, 'ailriturt pretp nwtr5[mt 5tmu[wrt iw', 'wureopt wrtnurt pwrt ', '', '', '', '', 'https://www.w3schools.com', 'https://www.w3schools.com/html/html_lists.asp'),
(3, 'rouorpt rtp uporutp urw', 'uopfgu uwrgtuop uoutr', '', '', '', '', 'Ordered HTML List', '');

-- --------------------------------------------------------

--
-- Table structure for table `ul5_ul5_1805`
--

CREATE TABLE `ul5_ul5_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `ul5_ul5_1805`
--

INSERT INTO `ul5_ul5_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'ertrtkhasdkfhk adfasdh  lfdg lyilfd khlsdf', 'iaret orwt upwrt ouwr ;ouiwrt ;ouwre ', '', '', '', '', 'Ordered HTML List', ''),
(2, 'uroeuopitnm rouo[', 'aopuiret j;sjf;g wr uipowruet ;oupourt ;u[wert ;u[wrt', '', '', '', '', 'Differencing.org', ''),
(3, 'wertupup uopwurt ;u[rt i[wret ', 'piw[rt iwrt iw[rt &#39;kir&#39;t &#39;ik&#39;qre iowrt ywt5r', '', '', '', '', 'asdfafdaf', 'https://www.w3schools.com/html/html_lists.asp'),
(4, 'rdfajhjlh klrfhgkl', 'rytueru eyuetyu rytutryu', '', '', '', '', '', 'https://www.w3schools.com/html/tryit.asp?filename=tryhtml_lists_unordered_none');

-- --------------------------------------------------------

--
-- Table structure for table `ul6_ol6_1805`
--

CREATE TABLE `ul6_ol6_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `ul6_ol6_1805`
--

INSERT INTO `ul6_ol6_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'etyuedtyu', 'rytuirtyuret', '', '', '', '', 'Differencing.org', 'https://www.w3schools.com/html/html_lists.asp'),
(2, 'qdsfqesd', 'qwertqwer', '', '', '', '', '', 'http://localhost:8000/input5.php'),
(3, 'reqtqreywe5ty  etrywerty etyuerty utjkryu ', ' ryueytuet', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `ul7_ol7_1805`
--

CREATE TABLE `ul7_ol7_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `ul7_ol7_1805`
--

INSERT INTO `ul7_ol7_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'adsf sghsfg', ' deghb dfg dfg dfgbnsd dfgbf', '', '', '', '', 'Differencing.org', 'http://localhost:8000/input5.php'),
(2, 'srgsrfg sdfgsdfg dsfghsfgh dhyjdghj fhg', ' fghjdghf hyjdyg fghjdgyh fhjdfgh fghjdgh ', '', '', '', '', '', 'https://www.w3schools.com/html/tryit.asp?filename=tryhtml_lists_unordered_none'),
(3, 'srftygstry dfghjdgfh fghjdgh', ' frhjdh fhjghj yjdety rtyujtym rythj rytujdty', '', '', '', '', 'https://www.w3schools.com', ''),
(4, 'ryhtjdetyu rytjedty', 'eyuetyue rtyujety tyhjtry', '', '', '', '', 'Ordered HTML List', '');

-- --------------------------------------------------------

--
-- Table structure for table `ul_ol_1805`
--

CREATE TABLE `ul_ol_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `ul_ol_1805`
--

INSERT INTO `ul_ol_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'Ordered List.', 'Ordered List', '', '', '', '', 'Ordered HTML List', 'https://www.w3schools.com/html/tryit.asp?filename=tryhtml_lists_unordered_square'),
(2, 'No Numbering is there , only symbols is used. ', 'Numbering is present, different numbering system is used.', '', '', '', '', 'Differencing.org', 'http://localhost:8000/input5.php'),
(3, 'fhfhds ylifq urte ur', 'wu iwrt ;ouiowrt ouowrt owrt ;ouowr uosdfg o;uw', '', '', '', '', '', 'https://www.w3schools.com/html/html_lists.asp'),
(4, 'reqrouo wjreogjuop ;ouwr[eg ouureg ;i[re i[re', 'oreouo uourot upqrut uoureot', '', '', '', '', 'Differencing.org', '');
...
--
-- Table structure for table `w11_q11_1805`
--

CREATE TABLE `w11_q11_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `w11_q11_1805`
--

INSERT INTO `w11_q11_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'tgrgt', 'sfdgsdg', '', '', '', '', '', ''),
(2, 'jryturyt', 'nryurt', '', '', '', '', '', ''),
(3, 'hetye', 'hrety', '', '', '', '', '', '');
...
--
-- Table structure for table `wert_qwer_1805`
--

CREATE TABLE `wert_qwer_1805` (
  `sn` int(2) UNSIGNED NOT NULL,
  `topic1` text,
  `topic2` text,
  `imgname1` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `wert_qwer_1805`
--

INSERT INTO `wert_qwer_1805` (`sn`, `topic1`, `topic2`, `imgname1`, `imgname2`, `imgtype1`, `imgtype2`, `referencename`, `referenceurl`) VALUES
(1, 'asdasd', 'zfsdfg', '', '', '', '', '', ''),
(2, 'dfsdfsdf', 'dfghsfhsfh', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `__1805`
--
...
--
-- Indexes for table `a123_b123_1805`
--
ALTER TABLE `a123_b123_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `aasdasd_asdasd_1805`
--
ALTER TABLE `aasdasd_asdasd_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `addadadad_adadada_1805`
--
ALTER TABLE `addadadad_adadada_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `analolg_digital_1805`
--
ALTER TABLE `analolg_digital_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `aqq_bqq_1805`
--
ALTER TABLE `aqq_bqq_1805`
  ADD PRIMARY KEY (`sn`);
...
--
-- Indexes for table `articlen`
--
ALTER TABLE `articlen`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `articlen2`
--
ALTER TABLE `articlen2`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `asadaaasa_asasasas_1805`
--
ALTER TABLE `asadaaasa_asasasas_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `asasasas_qerwerwer_1805`
--
ALTER TABLE `asasasas_qerwerwer_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `asas_asasa_1805`
--
ALTER TABLE `asas_asasa_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `asdasdasdasd_awewerwerer_1805`
--
ALTER TABLE `asdasdasdasd_awewerwerer_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `calloc_malloc_1805`
--
ALTER TABLE `calloc_malloc_1805`
  ADD PRIMARY KEY (`sn`);
...
--
-- Indexes for table `csdf_sdf_1805`
--
ALTER TABLE `csdf_sdf_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `css_js_1805`
--
ALTER TABLE `css_js_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `cv1_vc1_1805`
--
ALTER TABLE `cv1_vc1_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `cv2_vc2_1805`
--
ALTER TABLE `cv2_vc2_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `cv21_vc21_1805`
--
ALTER TABLE `cv21_vc21_1805`
  ADD PRIMARY KEY (`sn`);
...
--
-- Indexes for table `db_dmw_1805`
--
ALTER TABLE `db_dmw_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `e1111_g111111_1805`
--
ALTER TABLE `e1111_g111111_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `ertertq_etqetqe_1805`
--
ALTER TABLE `ertertq_etqetqe_1805`
  ADD PRIMARY KEY (`sn`);
...
--
-- Indexes for table `extrinsic_geugudf_1805`
--
ALTER TABLE `extrinsic_geugudf_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `formal_actual_1805`
--
ALTER TABLE `formal_actual_1805`
  ADD PRIMARY KEY (`sn`);
...
--
-- Indexes for table `gjh_hjjg1805`
--
ALTER TABLE `gjh_hjjg1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `gsfdgsg_sfdgsfg_1805`
--
ALTER TABLE `gsfdgsg_sfdgsfg_1805`
  ADD PRIMARY KEY (`sn`);
...
--
-- Indexes for table `m1111_n1111_1805`
--
ALTER TABLE `m1111_n1111_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `mahi1_nm1_1805`
--
ALTER TABLE `mahi1_nm1_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `mahi2_nm2_1805`
--
ALTER TABLE `mahi2_nm2_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `mahi22_nm22_1805`
--
ALTER TABLE `mahi22_nm22_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `mahi221_nm221_1805`
--
ALTER TABLE `mahi221_nm221_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `mahi_namu_1805`
--
ALTER TABLE `mahi_namu_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `malloc1_calloc11805`
--
ALTER TABLE `malloc1_calloc11805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `malloc4_calloc4_1805`
--
ALTER TABLE `malloc4_calloc4_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `malloc5_calloc5_1805`
--
ALTER TABLE `malloc5_calloc5_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `malloc232_calloc34_1805`
--
ALTER TABLE `malloc232_calloc34_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `malloc_calloc1805`
--
ALTER TABLE `malloc_calloc1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `malloc_calloc_1805`
--
ALTER TABLE `malloc_calloc_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `me1_she1_1805`
--
ALTER TABLE `me1_she1_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `me_she_1805`
--
ALTER TABLE `me_she_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `mm1_nn2_1805`
--
ALTER TABLE `mm1_nn2_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `mm11_nn22_1805`
--
ALTER TABLE `mm11_nn22_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `mm112_nn222_1805`
--
ALTER TABLE `mm112_nn222_1805`
  ADD PRIMARY KEY (`sn`);
...
--
-- Indexes for table `nmnm_asa2_1805`
--
ALTER TABLE `nmnm_asa2_1805`
  ADD PRIMARY KEY (`sn`);
...
--
-- Indexes for table `olap1_oltp1_1805`
--
ALTER TABLE `olap1_oltp1_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `olap2_oltp2_1805`
--
ALTER TABLE `olap2_oltp2_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `olap3_oltp3_1805`
--
ALTER TABLE `olap3_oltp3_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `olap4_oltp4_1805`
--
ALTER TABLE `olap4_oltp4_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `olap5_oltp5_1805`
--
ALTER TABLE `olap5_oltp5_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `olap_oltp_1805`
--
ALTER TABLE `olap_oltp_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `oltp_olap_1805`
--
ALTER TABLE `oltp_olap_1805`
  ADD PRIMARY KEY (`sn`);
...
--
-- Indexes for table `qhh_retrt_1805`
--
ALTER TABLE `qhh_retrt_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `r11_s11_1805`
--
ALTER TABLE `r11_s11_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `rgfsdfg_sfdgsfdg_1805`
--
ALTER TABLE `rgfsdfg_sfdgsfdg_1805`
  ADD PRIMARY KEY (`sn`);
...
--
-- Indexes for table `sasd_dasd1805`
--
ALTER TABLE `sasd_dasd1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `sdfgsfg_fgsfdgwretw_1805`
--
ALTER TABLE `sdfgsfg_fgsfdgwretw_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `sdrrt_srtwert_1805`
--
ALTER TABLE `sdrrt_srtwert_1805`
  ADD PRIMARY KEY (`sn`);
...
--
-- Indexes for table `ss_ss1805`
--
ALTER TABLE `ss_ss1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `structure_union_1805`
--
ALTER TABLE `structure_union_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `t111_r111_1805`
--
ALTER TABLE `t111_r111_1805`
  ADD PRIMARY KEY (`sn`);
...
--
-- Indexes for table `u1111_v222222_1805`
--
ALTER TABLE `u1111_v222222_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `ul1_ol1_1805`
--
ALTER TABLE `ul1_ol1_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `ul2_ol2_1805`
--
ALTER TABLE `ul2_ol2_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `ul3_ol3_1805`
--
ALTER TABLE `ul3_ol3_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `ul4_ol4_1805`
--
ALTER TABLE `ul4_ol4_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `ul5_ul5_1805`
--
ALTER TABLE `ul5_ul5_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `ul6_ol6_1805`
--
ALTER TABLE `ul6_ol6_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `ul7_ol7_1805`
--
ALTER TABLE `ul7_ol7_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `ul_ol_1805`
--
ALTER TABLE `ul_ol_1805`
  ADD PRIMARY KEY (`sn`);
...
--
-- Indexes for table `w11_q11_1805`
--
ALTER TABLE `w11_q11_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `wert_qwer_1805`
--
ALTER TABLE `wert_qwer_1805`
  ADD PRIMARY KEY (`sn`);

--
-- Indexes for table `__1805`
--
ALTER TABLE `__1805`
  ADD PRIMARY KEY (`sn`);
...
--
-- AUTO_INCREMENT for table `a123_b123_1805`
--
ALTER TABLE `a123_b123_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `aasdasd_asdasd_1805`
--
ALTER TABLE `aasdasd_asdasd_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `addadadad_adadada_1805`
--
ALTER TABLE `addadadad_adadada_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `analolg_digital_1805`
--
ALTER TABLE `analolg_digital_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `aqq_bqq_1805`
--
ALTER TABLE `aqq_bqq_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `articlen`
--
ALTER TABLE `articlen`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `articlen2`
--
ALTER TABLE `articlen2`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `asadaaasa_asasasas_1805`
--
ALTER TABLE `asadaaasa_asasasas_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `asasasas_qerwerwer_1805`
--
ALTER TABLE `asasasas_qerwerwer_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `asas_asasa_1805`
--
ALTER TABLE `asas_asasa_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `asdasdasdasd_awewerwerer_1805`
--
ALTER TABLE `asdasdasdasd_awewerwerer_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `calloc_malloc_1805`
--
ALTER TABLE `calloc_malloc_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `csdf_sdf_1805`
--
ALTER TABLE `csdf_sdf_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `css_js_1805`
--
ALTER TABLE `css_js_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `cv1_vc1_1805`
--
ALTER TABLE `cv1_vc1_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `cv2_vc2_1805`
--
ALTER TABLE `cv2_vc2_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `cv21_vc21_1805`
--
ALTER TABLE `cv21_vc21_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `db_dmw_1805`
--
ALTER TABLE `db_dmw_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `e1111_g111111_1805`
--
ALTER TABLE `e1111_g111111_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `ertertq_etqetqe_1805`
--
ALTER TABLE `ertertq_etqetqe_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `extrinsic_geugudf_1805`
--
ALTER TABLE `extrinsic_geugudf_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `formal_actual_1805`
--
ALTER TABLE `formal_actual_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `gjh_hjjg1805`
--
ALTER TABLE `gjh_hjjg1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `gsfdgsg_sfdgsfg_1805`
--
ALTER TABLE `gsfdgsg_sfdgsfg_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `m1111_n1111_1805`
--
ALTER TABLE `m1111_n1111_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `mahi1_nm1_1805`
--
ALTER TABLE `mahi1_nm1_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `mahi2_nm2_1805`
--
ALTER TABLE `mahi2_nm2_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `mahi22_nm22_1805`
--
ALTER TABLE `mahi22_nm22_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `mahi221_nm221_1805`
--
ALTER TABLE `mahi221_nm221_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `mahi_namu_1805`
--
ALTER TABLE `mahi_namu_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `malloc1_calloc11805`
--
ALTER TABLE `malloc1_calloc11805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `malloc4_calloc4_1805`
--
ALTER TABLE `malloc4_calloc4_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `malloc5_calloc5_1805`
--
ALTER TABLE `malloc5_calloc5_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `malloc232_calloc34_1805`
--
ALTER TABLE `malloc232_calloc34_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `malloc_calloc1805`
--
ALTER TABLE `malloc_calloc1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `malloc_calloc_1805`
--
ALTER TABLE `malloc_calloc_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `me1_she1_1805`
--
ALTER TABLE `me1_she1_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `me_she_1805`
--
ALTER TABLE `me_she_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `mm1_nn2_1805`
--
ALTER TABLE `mm1_nn2_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `mm11_nn22_1805`
--
ALTER TABLE `mm11_nn22_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `mm112_nn222_1805`
--
ALTER TABLE `mm112_nn222_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `nmnm_asa2_1805`
--
ALTER TABLE `nmnm_asa2_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `olap1_oltp1_1805`
--
ALTER TABLE `olap1_oltp1_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `olap2_oltp2_1805`
--
ALTER TABLE `olap2_oltp2_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `olap3_oltp3_1805`
--
ALTER TABLE `olap3_oltp3_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `olap4_oltp4_1805`
--
ALTER TABLE `olap4_oltp4_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `olap5_oltp5_1805`
--
ALTER TABLE `olap5_oltp5_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `olap_oltp_1805`
--
ALTER TABLE `olap_oltp_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `oltp_olap_1805`
--
ALTER TABLE `oltp_olap_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `qhh_retrt_1805`
--
ALTER TABLE `qhh_retrt_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `r11_s11_1805`
--
ALTER TABLE `r11_s11_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `rgfsdfg_sfdgsfdg_1805`
--
ALTER TABLE `rgfsdfg_sfdgsfdg_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `sasd_dasd1805`
--
ALTER TABLE `sasd_dasd1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sdfgsfg_fgsfdgwretw_1805`
--
ALTER TABLE `sdfgsfg_fgsfdgwretw_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `sdrrt_srtwert_1805`
--
ALTER TABLE `sdrrt_srtwert_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `ss_ss1805`
--
ALTER TABLE `ss_ss1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `structure_union_1805`
--
ALTER TABLE `structure_union_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `t111_r111_1805`
--
ALTER TABLE `t111_r111_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `u1111_v222222_1805`
--
ALTER TABLE `u1111_v222222_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `ul1_ol1_1805`
--
ALTER TABLE `ul1_ol1_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `ul2_ol2_1805`
--
ALTER TABLE `ul2_ol2_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `ul3_ol3_1805`
--
ALTER TABLE `ul3_ol3_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `ul4_ol4_1805`
--
ALTER TABLE `ul4_ol4_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `ul5_ul5_1805`
--
ALTER TABLE `ul5_ul5_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `ul6_ol6_1805`
--
ALTER TABLE `ul6_ol6_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `ul7_ol7_1805`
--
ALTER TABLE `ul7_ol7_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `ul_ol_1805`
--
ALTER TABLE `ul_ol_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `w11_q11_1805`
--
ALTER TABLE `w11_q11_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `wert_qwer_1805`
--
ALTER TABLE `wert_qwer_1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `__1805`
--
ALTER TABLE `__1805`
  MODIFY `sn` int(2) UNSIGNED NOT NULL AUTO_INCREMENT;
COMMIT;
