                ...
                <div class="col-sm-12" ng-app="">       
                    ...
                    <div class="col-sm-6">
                        <div class="col-sm-12">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="UserId" class="form-control" id="comment" placeholder="Email Id" ng-model="">
                                </div>
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="UserId" class="form-control" id="comment" placeholder="password" ng-model="">
                                </div>
                        </div>
                    </div>   
                    </div>
