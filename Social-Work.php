...
<a href="#" class="list-group-item">getch()and getche()</a>
      ...
      <div class=" row container-fluid text-center">
            <h2>Some contribution for Society and Environment</h2>
            
          
        </div>
           <hr >
         <div class="row container-fluid text-center">
             <img src="Social_Work_Images/Mahendra_Plantation_31Aug.jpg" style="width: 400px;">
              <h3>Mr. Mahendra Gupta</h3>
              <p>Planted tree in front of Govt. Polytechnic College Anuppur.</p>
